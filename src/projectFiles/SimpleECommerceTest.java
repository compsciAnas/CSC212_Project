...
public class SimpleECommerceTest {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("11. Search customer by name [O(log n)]");
            System.out.println("12. View customer order history");
            System.out.println("--- Order Operations ---");
            System.out.println("13. Search order by ID [O(log n)]");
            System.out.println("14. Place an order");
            System.out.println("15. Cancel an order [O(log n)]");
            System.out.println("16. Update order status [O(log n)]");
            System.out.println("--- Phase II: Advanced Queries ---");
            System.out.println("17. View products in price range [Range Query]");
            System.out.println("18. View orders between dates [Range Query with AVL]");
            System.out.println("19. View customers sorted alphabetically [In-order Traversal]");
            System.out.println("20. View top 3 rated products");
            System.out.println("21. View top 3 most reviewed products");
            System.out.println("22. View customers who reviewed a product (sorted by rating)");
            System.out.println("--- Reviews ---");
            System.out.println("23. Add review to product");
            System.out.println("24. Edit review [O(log n)]");
            System.out.println("25. View customer reviews");
            System.out.println("26. View common high-rated products (rating > 4.0)");
            System.out.println("--- Other ---");
            System.out.println("27. View out of stock products");
            System.out.println("28. Performance comparison (Phase I vs Phase II)");
            ...
            switch (choice) {
                ...
                case 11:
                    ...
                    endTime = System.nanoTime();
                    if (foundByName != null) {
                        System.out.println("Customer found: " + foundByName);
                        System.out.println("Search time (AVL): " + (endTime - startTime) + " ns [O(log n)]");
                    } else {
                        System.out.println("Customer not found.");
